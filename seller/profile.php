        ...
        <section class="pbox container grid">
            <div class="profile_container">
                <div class="profile-box">
                    <a href="../seller/index.php"><i class="ri-arrow-left-line icon_panah"></i></a>
                    <span class="section_title profile_title1">Akun Saya</span> 
                </div>
                
                <div class="profile_box">
                    <span class="profile_acc"><?= $fetch_profile['name']; ?></span>
                </div>

                <div class="profile_box1">
                    <i class="ri-account-circle-line profile_icon"></i>
                    <span class="profile_desc"><?= $fetch_profile['number']; ?></span>
                </div>
                <a href="../seller/update_profile.php"><i class="ri-pencil-line profile_icon2"></i></a>
                <h3 class="profile_title2">Pengaturan Akun</h3>

                <div class="profile_box">
                    <a href="../seller/update_addres.php"><span class="profile_acc1">daftar alamat</span></a>
                </div>

                <div class="profile_box1">
                    <a href="../seller/update_addres.php"><i class="ri-store-3-line profile_icon3"></i></a>
                    <a href="../seller/update_addres.php"><span class="profile_desc1">atur alamat pengiriman belanjaan</span></a>
                </div>

                <div class="profile_box">
                    <a href="../seller/update_pass.php"><span class="profile_acc1">keamanan akun</span></a>
                </div>

                <div class="profile_box1">
                    <a href="../seller/update_pass.php"><i class="ri-lock-line profile_icon3"></i></a>
                    <a href="../seller/update_pass.php"><span class="profile_desc1">atur kata sandi anda</span></a>
                </div>
