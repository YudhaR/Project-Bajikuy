...
if(isset($_POST['submit'])){
    ...
    $select_lokasi = $conn->prepare("SELECT * FROM `lokasi` WHERE judul = ?");
    $select_lokasi->execute([$judul]);
    ...
    if($select_lokasi->rowCount() > 0){
       ...
       if($image_size > 2000000){
          ...
          $insert_lokasi = $conn->prepare("INSERT INTO `lokasi`(user_id, link, image, judul, deskripsi, waktu) VALUES(?,?,?,?,?,?)");
          $insert_lokasi->execute([$user_id, $link, $image, $judul, $deskripsi, $waktu]);
          ...
          $message[] = 'Lokasi Telah Ditambahkan!';
       }
        ...
        <section class="pbox container grid">
            <div class="profile_container">
                <div class="profile-box">
                    ...
                    <span class="section_title profile_title1">Tambah Lokasi</span> 
                </div>

                <div class="profile-box">
                    <h3 class="profile_title3">Tambahkan lokasi warungmu untuk memudahkan pelanggan untuk menemukan dan mencoba produkmu!</h3> 
                </div>
